...
{
  nh->param("keypose_graph/kAddNodeMinDist", kAddNodeMinDist, kAddNodeMinDist);
  nh->param("keypose_graph/kAddNonKeyposeNodeMinDist", kAddNonKeyposeNodeMinDist, kAddNonKeyposeNodeMinDist);
  nh->param("keypose_graph/kAddEdgeConnectDistThr", kAddEdgeConnectDistThr, kAddEdgeConnectDistThr);
  nh->param("keypose_graph/kAddEdgeToLastKeyposeDistThr", kAddEdgeToLastKeyposeDistThr, kAddEdgeToLastKeyposeDistThr);
  nh->param("keypose_graph/kAddEdgeVerticalThreshold", kAddEdgeVerticalThreshold, kAddEdgeVerticalThreshold);
  nh->param("keypose_graph/kAddEdgeCollisionCheckResolution", kAddEdgeCollisionCheckResolution, kAddEdgeCollisionCheckResolution);
  nh->param("keypose_graph/kAddEdgeCollisionCheckRadius", kAddEdgeCollisionCheckRadius, kAddEdgeCollisionCheckRadius);
                                           ...
                                           std::vector<bool> constraints)
{
  ...
  {
    ROS_ERROR("KeyposeGraph::GetConnectedNodeIndices: constraints size not equal to node "
                 "size");
    return;
  }
...
double KeyposeGraph::GetShortestPath(const geometry_msgs::Point& start_point,
                                     ...
                                     nav_msgs::Path& path, bool use_connected_nodes)
{
  if (nodes_.size() < 2)
  {
    if (get_path)
