      ...
      kRoomSegmentation3FEnable_(false)
{
    ...
    pub_room_node_ = nh_.advertise<tare_planner::RoomNode>("/room_nodes", 50);
    pub_room_node_list_ = nh_.advertise<tare_planner::RoomNodeList>("/room_nodes_list", 5);
...
void RoomSegmentationNode::publishRoomNodes() {
    tare_planner::RoomNodeList room_node_list_msg;
    ...
    for (const auto &id_room_node_pair : room_nodes_map_) {
        ...
        tare_planner::RoomNode room_node_msg;
