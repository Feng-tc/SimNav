...
namespace local_coverage_planner_ns
{
  ...
  {
    nh->param("kMinAddPointNumSmall", kMinAddPointNum, kMinAddPointNum);
    nh->param("kMinAddFrontierPointNum", kMinAddFrontierPointNum, kMinAddFrontierPointNum);
    nh->param("kGreedyViewPointSampleRange", kGreedyViewPointSampleRange, kGreedyViewPointSampleRange);
    nh->param("kLocalPathOptimizationItrMax", kLocalPathOptimizationItrMax, kLocalPathOptimizationItrMax);
  ...
  LocalCoveragePlanner::LocalCoveragePlanner(ros::NodeHandle* nh)
      : lookahead_point_update_(false), use_frontier_(true),
        ...
        configured_room_exploration_(false)
  {
    ...
    std::vector<int> &viewpoint_roomcandidate_indices)
  {
    ...
    // {
    //   ROS_WARN(//               "No room candidate viewpoints found");
    // }
  }
      ...
      int uncovered_point_num, int uncovered_frontier_point_num)
  {
    ...
    if (!configured_room_exploration_) {
