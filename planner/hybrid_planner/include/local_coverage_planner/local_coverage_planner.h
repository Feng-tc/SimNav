...
namespace local_coverage_planner_ns
{
  ...
  public:
    ...
    void SetConfiguredRoomExploration(bool configured_room_exploration)
    {
      configured_room_exploration_ = configured_room_exploration;
    }
  ...
  private:
    ...
    bool configured_room_exploration_;
