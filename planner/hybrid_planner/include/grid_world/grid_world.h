...
public:
  ...
  void SetPlanningBoundary(double x_min, double x_max,
  ...
  bool HasExploringCellsInRoom(int room_id) const;
  void GetExploringCellIndicesInRoom(int room_id, std::vector<int>& cell_indices) const;
  ...
  {
    // transferring from Eigen::Vector3d to geometry_msgs::Point
  ...
  void SetFoundObjectPosition(const geometry_msgs::Point& object_position)
  {
  ...
  void SetFoundAnchorObjectPosition(const std::vector<geometry_msgs::Point>& viewpoint_positions)
  {
...
private:
  ...
  bool planning_boundary_enabled_ = false;
  double planning_x_min_ = 0.0;
  double planning_x_max_ = 0.0;
  double planning_y_min_ = 0.0;
  double planning_y_max_ = 0.0;
  int cur_keypose_id_;
  geometry_msgs::Point robot_position_;
  ...
  geometry_msgs::Point door_position_;
  cv::Mat room_mask_;
  ...
  std::vector<geometry_msgs::Point> found_anchor_object_position_;
};
}  // namespace grid_world_ns
